...
const AccueilCommeMoyenPaiement = () => {
                                    ...
                                    <div className='cryptocurrency-slides'>
                                        <div className='single-cryptocurrency-box'>
                                            ...
                                            <div className='btn-box'>
                                                <Link href='/admin/wealthtech/stablecoin/comme-moyen-paiement/sur-plateforme'>
                                                    <Button
                                                        block
                                                        color="primary"
                                                        type="button"
                        ...
                        <div className='currency-selection text-center'>
                            ...
                            <div className='cryptocurrency-slides'>
                                    <div className='single-cryptocurrency-box'>
                                        <div className='d-flex align-items-center'>
                                        <div className='title'>
                                            <h3>Demandes d'utilisation de stablecoin sur E-commerces</h3>
                                        </div>
                                        </div>
                                        <div className='btn-box'>
...
export default AccueilCommeMoyenPaiement;
