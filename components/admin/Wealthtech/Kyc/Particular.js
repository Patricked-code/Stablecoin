...
const ValidParticular = () => {
    ...
    // RECUPERER TOUS LES KYC DU PARTICULIER
    useEffect(async() => {
            const getAllKycForParticular = async () => {
  ...
  return (
    <>
        ...
        <div className='' >
            <div className=' mx-15'>
                <div className='py-10'>
                    <h1 className='text-center'>Validation de Kyc particulier</h1>
                </div>
            </div>
...
export default ValidParticular;
