    ...
    useEffect(() => {
       (async () => {
            if (!!magic && !!provider) {
                ...
                // LA PARTIE QUI ENREGISTRE LES INFORMATIONS DE L'UTILISATEUR DèS SA 1ère CONNECTION
                const token = localStorage.getItem('tokenEnCours') //Le token récuperé

                // Dans cette variable monobjet_jsonR  se trouve les information de user importées 
                var monobjet_jsonR = localStorage.getItem("dataFirstEdition");
                var FirstEditionInfo = JSON.parse(monobjet_jsonR); //Mettre les infos en JSON
            
                if (userAddress) {
                const dataa = {
                    firstName:FirstEditionInfo.firstName,
                    lastName:FirstEditionInfo.lastName,
                    mobile:FirstEditionInfo.mobile,
                    address:userAddress,
                    codeCountry:FirstEditionInfo.codeCountry
                }
                ...
                console.log("data firstEdit", data)
                }else{
                    console.log("Votre adresse public est introuvable'")
                }
                // FIN LA PARTIE QUI ENREGISTRE
  ...
  //  ******************************************
    ...
    useEffect(async() => {
        ...
        console.log("token meoo=>",token)
            ...
            const res = await fetch('https://apiv3.liquidity.wealthtechinnovations.com/api/user', {
    ...
    useEffect(async() => {
        ...
        console.log("token me=>",token)
            ...
            // const resBank = await fetch("http://localhost:3080/api/bank/find-all", {
            const resBank = await fetch('https://apiv3.liquidity.wealthtechinnovations.com/api/bank/find-all', {
    ...
    useEffect(async() => {
        ...
        console.log("token me=>",token)
            ...
            // const resOperator = await fetch("http://localhost:3080/api/operator/find-all-Operators", {
            const resOperator = await fetch('https://apiv3.liquidity.wealthtechinnovations.com/api/operator/find-all-Operators', {
    ...
    const addAccountBank= async(event) =>{
        ...
        // const res = await fetch("http://localhost:3080/api/acount-bank/add-account-bank", {
            const res = await fetch("https://apiv3.liquidity.wealthtechinnovations.com/api/acount-bank/add-account-bank", {
              method:"POST",
              body: JSON.stringify(dataa),
              headers: {
                  'Content-Type': 'application/json',
    ...
    // FIN
     ...
     const addAccountMobile = async(event) =>{
        ...
        // const res = await fetch("http://localhost:3080/api/mobile/add-mobile", {
            const res = await fetch("https://apiv3.liquidity.wealthtechinnovations.com/api/mobile/add-mobile", {
              method:"POST",
              body: JSON.stringify(dataa),
              headers: {
                  'Content-Type': 'application/json',
