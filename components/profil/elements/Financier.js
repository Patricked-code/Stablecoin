    ...
    <>
      ...
      <div className='banner-area'>
        <div className='container'>
          <div className=''>
            <h1 className='text-center'>Institution et société financière</h1>
                ...
                <div className='currency-selection '>
                    <div className="mx-2">
                        <div className='my-3'>
                            ...
                            <p><b>Ville :</b> Bouaké</p>
                            <p><b>Contact :</b> 0575357643</p>
                            <p><b>Site internet:</b> google.com</p>
                            <p><b>Abréviation :</b> Abréviation ici</p>
                            <p><b>Dénomination :</b> Dénomination ici</p>
                            <p><b>type :</b> Fintech</p>
                            <p><b>Email :</b> fintect@gmail.com</p>
