    ...
    useEffect(() => {
       (async () => {
            if (!!magic && !!provider) {
                ...
                const res = await fetch(`${API_URL}/api/session/first-edition`, {
                    method:"PUT",
    ...
    <>
      ...
      <div className='banner-area'>
        <div className='container'>
          <div className=''>
            <h1 className='text-center'>Entreprise / Commerçant</h1>
                ...
                <div className='currency-selection '>
                    <div className="mx-2">
                        <div className='my-3'>
                            ...
                            <p><b>Nom :</b> Nom Ici</p>
                            <p><b>Pays :</b> Côte d'Ivoire</p>
                            <p><b>Ville :</b> Abidjan</p>
                            <p><b>Contact :</b> 0575357643</p>
                            <p><b>Site internet:</b> google.com</p>
                            <p><b>Secteur d'activité :</b> Secteur d'activité ici</p>
                            <p><b>Forme juridique :</b> Forme juridique ici</p>
                            <p><b>Numéro du régistre:</b>099767863663577523 </p>
                            <p><b>Nombre d'employés:</b> Plus que 200</p>
                            <p><b>type :</b> Personne physique</p>
                            <p><b>Email :</b> entreprise@gmail.com</p>
        ...
        <div className='col-lg-12 col-md-12 row'>
                    {/* <div className='col-lg-3 col-md-3'></div> */}
                        ...
                        <div className='currency-selection text-center'>
                            <Link href='/account/twoEdition'>
                                <div className=" btn rounded-pill my-3 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg  rounded-xl bg-primary text-white">
                                    Integrer E-WARI dans mon site comme moyen de paiement
                                </div>
                            </Link>
                        </div>
                        </div>
