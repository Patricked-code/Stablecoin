            ...
            {/* {currentUser?.profileId==2 || currentUser?.profileId==3?( */}
                ...
                <>
                    <div className='' >
                        <div className=' mx-15'>
                            <div className='py-10'>
                                <h1 className='text-center'>Historiques des transactions bancaires</h1>
                            </div>
                        </div>
                        ...
                        <div className='cryptocurrency-search-box'>
                            ...
                            >
                                <Table.Header>
                                    ...
                                    <Table.Column><p className="gr-text-8 pt-3 pb-0 ">Iban</p></Table.Column>
                                ...
                                <Table.Body>
                                    {/* {allKycForParticular?.map((data) => ( */}
                                        <Table.Row >                       
                                            ...
                                            <Table.Cell ><small className=" py-0 ">0233 726545 925 265 928</small></Table.Cell>
