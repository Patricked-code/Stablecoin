  ...
  return (
    ...
    <>
      <div className='' >
        <div className=' mx-15'>
            <div className='py-10'>
                <h1 className='text-center'>Liste des historiques</h1>
            </div>
        </div>
                                    ...
                                    <div className='cryptocurrency-slides'>
                                        <div className='single-cryptocurrency-box'>
                                            ...
                                            <div className='btn-box'>
                                                <a href='/profil/historique/stablecoin'>
                                                    <Button
                                                        block
                                                        color="primary"
                                                        type="button"
                            ...
                            <div className='currency-selection text-center'>
                                ...
                                <div className='cryptocurrency-slides'>
                                        <div className='single-cryptocurrency-box'>
                                            ...
                                            <div className='btn-box'>
                                                <a href='/profil/historique/bancaire'>
                                                    <Button
                                                        block
                                                        color="primary"
                                                        type="button"
...
export default CDashbaordHistorique;
