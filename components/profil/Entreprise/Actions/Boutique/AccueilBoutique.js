...
const AccueilBoutique = () => {
    ...
    const withdrawAllApprovedFunds = async () => {
     ...
     // Fonction d'enregistrement des données du retrait dans l'historique
  ...
  return (
    <>
      ...
      <div className='' >
        <div className=' mx-15'>
            <div className='py-10'>
                <h1 className='text-center'>Ma recette de vente sur la plateforme</h1>
            </div>
        </div>
                                ...
                                <div className='cryptocurrency-slides'>
                                    <div className='single-cryptocurrency-box'>
                                        ...
                                        <div className='title pb-0'>
                                            ...
                                            <p>Mon solde de vente sur la plateforme non récupéré: <br/><b className='colorRed'>{balanceEscrow}</b> {symbolStablecoin}</p>
