...
const VerifyDocumentsAgenceRetrait = () => {
                        ...
                        <div className="form-group my-6 ">
                          ...
                          <div className='row'>
                            <div className='col-lg-6 col-md-6' onClick={()=>setShowInput(0)}>
                              <p className=' '  onClick={()=>setAddressTo("")}>
                                <button className='pb-5 pt-2 my-3 ' onClick={()=>setShowScanner(1)} disabled={isLoggingIn}>Cliquez ici pour scanner le QR code du recepteur </button>
                              </p>
                            </div>
...
export default VerifyDocumentsAgenceRetrait;
