...
const CIformationFinanciereFive = () => {
    ...
    const [deviseOne, setDeviseOne] = useState('');
    const [deviseTwo, setDeviseTwo] = useState('');
    const [deviseThree, setDeviseThree] = useState('');
    ...
    const handleDeviseOneChange = (e) => {
        setDeviseOne(e.target.value);
    };

    const handleDeviseTwoChange = (e) => {
        setDeviseTwo(e.target.value);
    };

    const handleDeviseThreeChange = (e) => {
        setDeviseThree(e.target.value);
      };
                ...
                <div className='col-lg-3 col-md-12'></div>
                    <div className='m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg  rounded-xl bg-white cryptocurrency-search-box login-form col-lg-6 col-md-12'>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                <option value="">Sélectionner un élément</option>
                                <option value="CFA">Côte d'Ivoire</option>
                                <option value="Euro">Mali</option>
                                <option value="Dollar">Algérie</option>
                            </select>
                            </label>
                            ...
                            <div className="form-group mb-6 mt-3 col-lg-12 col-md-12  row justify-content-between">
                                    ...
                                    <div className="form-group mb-6 mt-3 col-lg-6 col-md-6">
                                        <Link href='/profil/kyc/entreprise/documents-legaux/' className="align-right">
                                            <a
                                            className=""
                                            >
                                                <button className="btn btn-primary " type='button'> Soumettre </button>
                                            </a>   
                                        </Link>
                                    </div>
                              </div>
