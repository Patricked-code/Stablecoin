...
const CIformationFinanciereTwo = () => {
  ...
  // ENVOIES DES DONNEES DES INFORMATIONS FINANCIERES (TRIMESTRIELLE) 
  const addFinancialInformationQuarterly = async (e) => {
    e.preventDefault();
    setIsLoggingIn(true);
  ...
  // ENVOIES DES DONNEES DES INFORMATIONS FINANCIERES (TRIMESTRIELLE) 
  const updateFinancialInformationQuarterly = async (e) => {
    e.preventDefault();
    setIsLoggingIn(true);
    ...
    <>
      {showProgressBar && <ProgressBar className="mb-15" steps={stepsEntreprise} activeStep={activeStepEntreprise} />}
        ...
        <div className='mt-15' >
            <div className=' mx-15'>
                <div className='py-10'>
                    <br/><br/><h1 className='text-center '>Autre information financière et transactions 2</h1>
                </div>
            </div>
...
export default CIformationFinanciereTwo;
