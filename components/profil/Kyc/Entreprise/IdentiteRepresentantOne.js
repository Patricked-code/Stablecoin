...
const CIdentiteRepresentantOne = () => {
    ...
    // Fonction de modification des infos du champ numberRepresentatives dans la table kyc_entreprise
    const updateNumberRepresentatives = async(event) => {
        setIsLoggingIn(true);
        ...
        try {
            ...
            const dataInfos = {
                numberRepresentatives:numberRepresentatives
            }
                const token = localStorage.getItem('tokenEnCours') //Le token récuperé

                const result = await fetch(`${API_URL}/api/kyc/business/update-kyc-for-number-representatives`, {
                method:"PUT",
                ...
                Swal.fire({
                    ...
                    setTimeout(() => {
                        if (currentKycStatut==="1") {
                            ...
                            Router.push("/profil/kyc/entreprise/identite-representant-two"); 
                        }
                    }, 5000)
                }
                // Fin condition 
            ...
            <div className='row'>
                <div className='col-lg-3 col-md-12'></div>
                    ...
                    <div className='m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg  rounded-xl bg-white cryptocurrency-search-box login-form col-lg-6 col-md-12'>
                        <form className='' onSubmit={updateNumberRepresentatives}>
...
export default CIdentiteRepresentantOne;
