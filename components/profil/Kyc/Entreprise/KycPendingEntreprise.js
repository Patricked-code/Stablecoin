...
const KycPendingEntreprise = () => {
    ...
    const [kycForUserEntreprise, setKycForUserEntreprise] = useState();
    ...
    const [updateKycEntrepriseStatut, setUpdateKycEntrepriseStatut] = useState("0");
    ...
    // RECUPERER LE KYC DE L'UTILISATEUR ENTREPRISE CONNECTE
    useEffect(async() => {
    const token = localStorage.getItem('tokenEnCours')
    
        const getKycForUserForEntreprise = async () => {
        const resKyc = await fetch(`${API_URL}/api/kyc/entreprise/find-kyc-entreprise-for-user`, {
            ...
            .then((data) => {
            setKycForUserEntreprise(data)
            }) 
        };
        // console.log("Banques =>",allBank)
        await getKycForUserForEntreprise();
    }, []);
    // FIN
                                ...
                                <div className='col-lg-12 col-md-12 row justify-content-between'>
                                        ...
                                        <Table.Header>
                                            ...
                                            <Table.Body>
                                                    ...
                                                    <Table.Row>                       
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(1)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validQuiz==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : ( <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(2)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validLegalDocuments==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : (  <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(3)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validResidence==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : (  <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(4)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validIdentity==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : (  <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(5)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validPhoto==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : (  <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 " onClick={()=>setEtape(6)}><button className='bgColorblue text-white' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}>Voir détails</button> {kycForUserEntreprise?.validSignature==1 ? ( <Icon icon="bx:chevron-down-circle" width={30} color="#208454" /> ) : (  <Icon icon="bx:x-circle" width={30} color="#dc3545" />)} </p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 ">{kycForUserEntreprise?.validQuiz==1 && kycForUserEntreprise?.validLegalDocuments==1 && kycForUserEntreprise?.validIdentity==1 && kycForUserEntreprise?.validResidence==1 && kycForUserEntreprise?.validPhoto==1 && kycForUserEntreprise?.validSignature==1 ? (<b className='colorGreen'>Valider</b>):(<b className='colorRed'>En cours</b>)}</p></Table.Cell>
                                                        <Table.Cell ><p className=" py-0 ">{formatDate(kycForUserEntreprise?.updatedAt)}</p></Table.Cell>
                                                        <Table.Cell>
                                                            <div className="d-flex py-0 ">
                                                                <p className="text-center">
                                                                                            
                                                                    <Button type='button' onClick={()=>setIdKycForEntreprise(kycForUserEntreprise?.id)}  color='success' className=''>
                        ...
                        <div className='row justify-content-between'>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validQuiz==1 ? (
                                    <a href='/profil/kyc/entreprise/questionnaire/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validLegalDocuments==1 ? (
                                    <a href='/profil/kyc/entreprise/documents-legaux/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                                        <Button  type='button'  color="primary" >
                                            Récompleter 
                                        </Button>
                                    </a>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validIdentity==1 ? (
                                    <a href='/profil/kyc/entreprise/justificatif-identite/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                                        <Button  type='button'  color="primary" >
                                            Récompleter 
                                        </Button>
                                    </a>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validResidence==1 ? (
                                    <a href='/profil/kyc/entreprise/justificatif-domicile/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                                        <Button  type='button'  color="primary" >
                                            Récompleter 
                                        </Button>
                                    </a>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validPhoto==1 ? ( 
                                    <a href='/profil/kyc/commun/selfie/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                                        <Button  type='button'  color="primary" >
                                            Récompleter 
                                        </Button>
                                    </a>
                            ...
                            <div className='form-group my-3 col-lg-6 col-md-6'>
                                ...
                                {!oneKycForEntreprise?.validSignature==1 ? (
                                    <a href='/profil/kyc/commun/signature/' onClick={()=>setUpdateKycEntrepriseStatut("1")}>
                                        <Button  type='button'  color="primary" >
                                            Récompleter 
                                        </Button>
                                    </a>
...
export default KycPendingEntreprise;
