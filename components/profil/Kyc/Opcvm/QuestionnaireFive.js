...
const CQuestionnaireFive = () => {
    ...
    const answerTwo = "Je peux faire face à toutes mes obligations financières ; toutefois, j’ai très peu ou pas d’épargnes.";
    const answerThree = "Je peux faire face à toutes mes obligations financières, et je suis en mesure d’épargner moins de 10 % de mon revenu.";
    const answerFour = "Je peux faire face à toutes mes obligations financières, et je suis en mesure d’épargner 10 % de mon revenu ou plus.";
    const answerFive = "J’ai peu d’obligations financières et beaucoup d’épargnes.";
...
export default CQuestionnaireFive;
