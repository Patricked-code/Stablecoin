...
export default function CardInvestissement() {
            ...
            <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white">
                    <div className="mt-4 p-4">
                        <p className="text-xl font-semibold text-gray-700 text-center">
                            ...
                            NSIA Epargne : {montantNsia} E-WARI
                        </p>
                    </div>
                    {/* <h4 className="text-center my-3">Souscription</h4> */}

                    <form onSubmit={handleSubmit} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteNsia} onChange={(e)=>setQuantiteNsia(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForNsia}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" disabled={disable} onClick={sell_tokenEcfa}  className="btn btn-success" >Souscription</button>
                            </div>
                        </div>
                    </form>
                    </div>
                    {/* <h4 className="text-center my-3">Rachat</h4> */}
                    <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white "><br/>
                    <form onSubmit={handleSubmitRachat} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteRachatNsia} onChange={(e)=>setQuantiteRachatNsia(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForRachatNsia}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenRachatEcfa}  className="btn btn-danger">Rachat<i className="text-danger"> . . ......</i></button>
                            </div>
            ...
            <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white">
                    <div className="mt-4 p-4">
                        <p className="text-xl font-semibold text-gray-700 text-center">
                            ...
                            Crepmf Actions : {montantCrepmf} E-WARI
                        </p>
                    </div>
                    {/* <h4 className="text-center my-3">Souscription</h4> */}
                    <form onSubmit={handleSubmitC} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteCrepmf} onChange={(e)=>setQuantiteCrepmf(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForCrepmf}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit"  onClick={sell_tokenCrepmf} className="btn btn-success" >Souscription</button>
                            </div>
                        </div>
                    </form>
                    </div>
                    ...
                    <form onSubmit={handleSubmitRachatC}>
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteRachatCrepmf} onChange={(e)=>setQuantiteRachatCrepmf(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForRachatCrepmf}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenRachatCrepmf}  className="btn btn-danger ">Rachat <i className="text-danger"> . . ......</i></button>
                            </div>
            ...
            <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white">
                    <div className="mt-4 p-4">
                        <p className="text-xl font-semibold text-gray-700 text-center">
                            ...
                            Sicav Abdou Diouf : {montantSicav} E-WARI
                        </p>
                    </div>
                    <form onSubmit={handleSubmitS}>
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteSicav} onChange={(e)=>setQuantiteSicav(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForSicav}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenSicav} className="btn btn-success" >Souscription</button>
                            </div>
                        </div>
                    </form>


                    <form onSubmit={handleSubmitRachatS} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteRachatSicav} onChange={(e)=>setQuantiteRachatSicav(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForRachatSicav}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenRachatSicav}  className="btn btn-danger">Rachat</button>
                            </div>
            ...
            <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white">
                    <div className="mt-4 p-4">
                        <p className="text-xl font-semibold text-gray-700 text-center">
                            ...
                            Sicav Ecobank : {montantEcobank} E-WARI
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmitE}>
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteEcobank} onChange={(e)=>setQuantiteEcobank(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForEcobank}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenEcobank} className="btn btn-success" >Souscription</button>
                            </div>
                        </div>
                    </form>


                    <form onSubmit={handleSubmitRachatE} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteRachatEcobank} onChange={(e)=>setQuantiteRachatEcobank(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForRachatEcobank}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenRachatEcobank}  className="btn btn-danger">Rachat</button>
                            </div>
            ...
            <div className="m-4 credit-card w-full lg:w-3/4 sm:w-auto shadow-lg rounded-xl bg-white">
                    ...
                    <form onSubmit={handleSubmitF}>
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteCoris} onChange={(e)=>setQuantiteCoris(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForCoris}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenCoris} className="btn btn-success" >Souscription</button>
                            </div>
                        </div>
                    </form>


                    <form onSubmit={handleSubmitRachatF} className="my-3">
                        <div className="row  mx-3">
                            <div className="col-lg-6 col-md-6 text-center my-2 ">
                                <div className="input-group ">
                                    <input type="number" defaultValue={quantiteRachatCoris} onChange={(e)=>setQuantiteRachatCoris(e.target.value)} placeholder="Quantite" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " />
                                </div>
                                <Icon icon="bx:arrow-from-top" />

                                <div className="input-group ">
                                    <input type="number"  value={montantSaisiForRachatCoris}  placeholder="Montant E-WARI" aria-describedby="addon-wrapping  autoFocus" className="input input-sm input-bordered " disabled />
                                    E-WARI
                                </div>
                            </div>

                            <div className="col-lg-6 col-md-6   mb-3">
                                <button type="submit" onClick={sell_tokenRachatCoris}  className="btn btn-danger">Rachat</button>
                            </div>
