                ...
                <div className='banner-wrapper-content'>
                    <div className=' text-center'>
                        <div className=" text-center rounded-pill my-3 px-5   rounded-xl bg-primary text-white ">
                            Les Frais de concours et de Scolarité
                        </div>
                    </div>
                </div>
              </div>
            ...
            <div className='buy-sell-cryptocurrency-area pt-100 pb-70'>
                <div className='container'>
                    <div className='section-title'>
                        <h4>Payer vos frais de dossier des concours et de Scolarité</h4>
                        <p>
                            Utilisez votre jeton E-WARI pour payer vos frais de concours et de Scolarité.
                        </p>
                    </div>
                    <div className='row justify-content-center'>
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <img src='/images/ecfa/ecosysteme/administratives/administ7.jpg' width={600} alt='image' />
                                <h3>Frais de dossier concours de police</h3>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <img src='/images/ecfa/ecosysteme/administratives/administ9.jpg' height="10" width={170} alt='image' />
                                <h3>Frais de dossier concours de l'ENA</h3>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <img src='/images/ecfa/ecosysteme/administratives/administ12.jpg' height="10" width={400} alt='image' />
                                <h3>Frais d'inscription Scolaire 2022-2023</h3>
