...
export default function CardProduit() {
    ...
    // ADRESS DE RECEPTION
    let adresseToImpot = "0xC4CaDf1cdA04718FDFdd920cbEf37490C10A2EcB"
    let adresseToDouane = "0xC4CaDf1cdA04718FDFdd920cbEf37490C10A2EcB"
    let adresseToAmende = "0xC4CaDf1cdA04718FDFdd920cbEf37490C10A2EcB"
            ...
            <div className='buy-sell-cryptocurrency-area pt-100 pb-70'>
                <div className='container'>
                    <div className='section-title'>
                        <h4>Parcourez les produits de Wealthtech Innovations</h4>
                        <p>
                            Utilisez le jeton E-WARI de votre portefeuille pour effectuer vos achats en toute sécurité.
                        </p>
                    </div>
                    <div className='row justify-content-center'>
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <div className='icon'>
                                    <img src='/images/ecfa/ecosysteme/ecommerces/produits/prod8.jpg' width={150} height={10} alt='image' />
                                </div>
                                <h3 className="mb-4">Ventilateur</h3>
                                <p>Ventilateur de très bonne qualité</p>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <div className='icon'>
                                    <img src='/images/ecfa/ecosysteme/ecommerces/produits/prod3.jpg' width={200} height={10} alt='image' />
                                </div>
                                <h3 >Fauteuils salon</h3>
                                <p>Fauteil bien confortable </p>
                        ...
                        <div className='col-lg-4 col-md-6 col-sm-6'>
                            <div className='single-buy-sell-item'>
                                <div className='icon'>
                                    <img src='/images/ecfa/ecosysteme/ecommerces/produits/prod1.jpg' width={190} height={10} alt='image' />
                                </div>
                                <h3 >Moto KTM</h3>
                                <p>Moto KTM de grande marque</p>
