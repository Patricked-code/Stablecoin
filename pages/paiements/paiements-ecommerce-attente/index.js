...
const PaiementEboutik = () => {
   ...
   */
    ...
    const [secondsRemaining, setSecondsRemaining] = useState(700 * 60 ); //Changer le temps ici aussi en 10 Min
        ...
        // try {
            ...
            if (dataMerchantByIdentifier?.addressEscrow) {
                ...
                if (magicCurrentBalance._hex>=amountWei._hex) {
                    ...
                    cancelPayment() //Appel de la fonction d'annulation de transaction
    ...
    const cancelPayment= async() =>{
        ...
        .then(res=>{
            ...
            Swal.fire({
                position: 'center',
                icon: 'success',
                html: "<p> Paiement annulé avec succès.<br/> Nous vous avons transmis un email de confirmation en ce sens.</p>" ,
                showConfirmButton: false,
                timer: 10000
            })
   ...
   */
    ...
    useEffect(() => {
        if (
          ...
          dataPaymentPending?.createdAt
            ...
            let remainingTime = 700 * 60 - Math.floor(initialTimeDifference); //Changer le temps ici aussi en 10 Min
    ...
    const formatTime = (seconds) => {
        ...
        return `${minutes}:${remainingSeconds < 700 ? '0' : ''}${remainingSeconds}`; //Changer le temps ici aussi en 10 Min
      };
    ...
    useEffect(() => {
        ...
        if (showDelete || showConfirmPayment) {
